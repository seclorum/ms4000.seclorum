...
// A MagicShifter mode can be activated by the user through system-events, i.e.
// buttons, shaking, etc. start happens when the user selects the mode stop
// happens when the user switches to another mode, before any other modes are
// started step allows the mode time to itself to compute, do and schedule
// things
